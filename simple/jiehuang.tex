...
\section{Skills}
\begin{small}
Git, Linux, \textbf{Python}, C, Shell, \textbf{Tensorflow}, Embedded Systems Programming, \textbf{LAMMPS}, \textbf{CP2K}
\end{small}
\\

\section{Activities}
\begin{tabular}{r|l}	
	2021/11                        & Teaching "Introduction to Deep Learning" for 
	 postgraduates in Physics \\ & at Wenzhou University.\\
	\multicolumn{2}{c}{} \\	% this is just an empty row
